...
//todo
	...
	setupCache.PWMMode 								= 0;
	setupCache.BTMode 								= 0;
	setupCache.ADCModeNick 							= 1;
	setupCache.ADCModeRoll 							= 1;
	setupCache.ADCModePitch 						= 1;
...
void setToInSettings(void)
{
	...
	fcSetup.pid_X_ACC_P  				= (float)setupCache.pid_X_ACC_P/100;
	fcSetup.pid_X_ACC_I  				= (float)setupCache.pid_X_ACC_I/30000;
	fcSetup.pid_X_ACC_D	  				= (float)setupCache.pid_X_ACC_D/100;
	...
	fcSetup.pid_Y_ACC_P  				= (float)setupCache.pid_Y_ACC_P/100;
	fcSetup.pid_Y_ACC_I  				= (float)setupCache.pid_Y_ACC_I/30000;
	fcSetup.pid_Y_ACC_D	  				= (float)setupCache.pid_Y_ACC_D/100;
	...
	fcSetup.baroChan					= setupCache.barChan;
	fcSetup.baroOffset					= setupCache.barOffset;

	fcSetup.components[compassComponent]	 	= setupCache.compOn;
	fcSetup.compBias					= setupCache.compBias;
	fcSetup.compForce					= setupCache.compForce;
	fcSetup.compType					= setupCache.compType;
