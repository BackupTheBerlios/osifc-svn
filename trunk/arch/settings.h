...
typedef struct
{
	...
	unsigned char	rollServoChan;				//roll servo RC Channel
	...
	unsigned char	compBias;
	unsigned char	compForce;
	...
	unsigned char	baroChan;
	unsigned char	baroOffset;
...
typedef struct {
	...
	unsigned char	pid_X_ACC_P;
	unsigned char	pid_X_ACC_I;
	unsigned char	pid_X_ACC_D;
	...
	unsigned char	pid_Y_ACC_P;
	unsigned char	pid_Y_ACC_I;
	unsigned char	pid_Y_ACC_D;
